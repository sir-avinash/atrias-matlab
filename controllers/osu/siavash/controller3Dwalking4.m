function [eStop, u, userOut, dxy, dxy_f] = controller3Dwalking4(q, dq, userIn)
...
dx_des=clamp(dx_des,dx_des_p-.2*(ti-tp),dx_des_p+.2*(ti-tp));
dy_des=clamp(dy_des,dy_des_p-.2*(ti-tp),dy_des_p+.2*(ti-tp));
